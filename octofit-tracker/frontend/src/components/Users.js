...
const getApiUrl = () => {
  ...
  console.log('[Users] REST API endpoint:', baseUrl);
  return baseUrl;
};
...
function Users() {
  ...
  const fetchData = () => {
    const url = getApiUrl();
    console.log('[Users] Fetching data from', url);
    setLoading(true);
    setError(null);
      ...
      <div className="card-body">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            ...
            <p className="text-muted mb-0">View the user records provided by the backend API.</p>
          </div>
