...
const getApiUrl = () => {
  ...
  console.log('[Workouts] REST API endpoint:', baseUrl);
  return baseUrl;
};
...
function Workouts() {
  ...
  const fetchData = () => {
    const url = getApiUrl();
    console.log('[Workouts] Fetching data from', url);
    setLoading(true);
    setError(null);
      ...
      <div className="card-body">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            ...
            <p className="text-muted mb-0">Review workouts from the backend REST API.</p>
          </div>
        ...
        <form className="row g-3 align-items-end mb-4" onSubmit={(event) => event.preventDefault()}>
          <div className="col-md-8">
            ...
            <input
              ...
              placeholder="Search workout fields"
              value={searchQuery}
